// SHA-256 for the puzzle solution hash. Web Crypto when available (it is not
// exposed on some file:// origins), otherwise a compact JS fallback.
...
/**
 * Canonical solution hash: sha256 over the real plates' filenames, sorted and
 * comma-joined. Order-independent, so it verifies a set without revealing it.
 */
export const solutionHash = (filenames) => sha256Hex([...filenames].sort().join(','));
